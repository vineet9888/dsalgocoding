...
public class StoneGame {
    ...
    public static boolean playStoneGame(int[] piles , int alexScore , int leeScore , int index , int low , int high) {
        ...
        if(index % 2 == 0) {
            return playStoneGame(piles,alexScore + piles[low] , leeScore , index + 1 ,low+1, high) ||
            playStoneGame(piles,alexScore + piles[high],leeScore,index+1,low,high-1);
        } else {
            return playStoneGame(piles , alexScore , leeScore + piles[low] , index +1 ,low + 1, high) ||
            playStoneGame(piles, alexScore,leeScore + piles[high],index+1,low,high-1);
        }
    }
